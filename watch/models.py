...
class Business(models.Model):
    bizz_photo = models.ImageField(upload_to='business/',null=True)
    bizz_name = models.CharField(max_length=100, blank=True, null=True)
    bizz_description = models.TextField(max_length=200, blank=True, null=True)
    bizz_email = models.CharField(max_length=100, blank=True, null=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE,null=True)
